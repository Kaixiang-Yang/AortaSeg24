...
class NetworkTrainer(object):
    def __init__(self, deterministic=True, fp16=False):
        ...
        self.dice_eval = None #use dice to store the best model
        self.train_loss_MA = None
        self.best_val_eval_criterion_MA = None
        self.best_dice_eval = None #use dice to store the best model
    ...
    def run_training(self):
        ...
        while self.epoch < self.max_num_epochs:
            ...
            if self.epoch >= self.max_num_epochs * 1 // 4 - 1:
                if (self.epoch+1) % 50 == 0 or self.epoch >= self.max_num_epochs - 10:
                    self.save_checkpoint(join(self.output_folder, "model_ep_%03.0d.model" % (self.epoch)))
            # if self.epoch >= self.max_num_epochs - 10:
            #     self.save_checkpoint(join(self.output_folder, "model_ep_%03.0d.model" % (self.epoch)))
    ...
    def update_eval_criterion_MA(self):
        ...
        if self.val_eval_criterion_MA is None:
            if len(self.all_val_eval_metrics) == 0:
                ...
                self.dice_eval = self.all_val_eval_metrics[-1]####
        else:
            if len(self.all_val_eval_metrics) == 0:
                """
    ...
    def manage_patience(self):
        ...
        if self.patience is not None:
            ...
            if self.best_dice_eval is None:
                self.best_dice_eval = self.dice_eval####ykx20230123
            ...
            # if self.dice_eval > self.best_dice_eval:
            #     self.best_dice_eval = self.dice_eval
