...
from nnunet.training.loss_functions.focal_loss import *
...
class FocalLossV2(nn.Module):
    ...
    def forward(self, logit, target):
        ...
        pt = (one_hot_key * logit).sum(1) + self.smooth #sum in channel-level
        logpt = pt.log()
...
class TverskyLoss(nn.Module):
    def __init__(self, apply_nonlin=None, batch_dice=False, do_bg=True, alpha_Tver=0.3, smooth=1.):
